...
function flag(code){const emoji=flagEmoji(code); return `<span class="flag-fallback" aria-hidden="true">${emoji}</span><img class="flag-img" src="https://flagcdn.com/w160/${String(code).toLowerCase()}.png" alt="Bandeira" loading="lazy" onerror="this.remove()">`}
